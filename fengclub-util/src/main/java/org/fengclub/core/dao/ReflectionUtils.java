...
import org.fengclub.util.string.StringUtil;
...
public class ReflectionUtils {
	...
	/**
	 * 通过反射, 获得Interface定义中声明的父类的泛型参数的类型. 如无法找到, 返回Object.class.
	 * 
	 * 如public UserDao extends HibernateDao<User,Long>
	 * 
	 * @param clazz
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static Class getSuperInterfacesGenricType(final Class clazz, final int index) {
